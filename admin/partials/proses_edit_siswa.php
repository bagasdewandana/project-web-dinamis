<?php 
	...
	if (isset($_POST['btn_submit'])) {
		...
		$query_update = $koneksi->query("UPDATE tb_siswa SET nama_siswa='$nama_siswa', nis_siswa='$nis_siswa', jenis_kelamin='$jenis_kelamin', agama_siswa = '$agama_siswa', no_telp='$no_telp' WHERE id_siswa = $id_siswa");
		if ($query_update) {
